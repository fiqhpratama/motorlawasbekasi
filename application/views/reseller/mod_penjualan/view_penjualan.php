                  ...
                  <?php 
                    ...
                    echo "<tr><td>$no</td>
                              ...
                              <td><center>
                                ...
                                <a class='btn btn-default btn-xs' title='$status Data' href='".base_url()."reseller/proses_penjualan/$row[id_penjualan]/$ubah' onclick=\"return confirm('Apa anda yakin untuk ubah status jadi $status?')\"><span class='glyphicon glyphicon-$icon'></span></a>
