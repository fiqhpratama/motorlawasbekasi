...
echo "<div class='wrapper'>			
	<div class='header-logo'>";
		  ...
		  foreach ($logo->result_array() as $row) {
			echo "<a href='".base_url()."'><img style='height:120px' src='".base_url()."asset/logo/$row[gambar]'/></a>";
		  }
	echo "
	</div>	
		...
		<span class='city'>
          ...
          if ($this->session->id_konsumen != ''){
			...
			echo "<a href='".base_url()."members/keranjang'><b> Keranjang Belanja <span class='badge'>".rupiah($isi_keranjang['jumlah'])."</span></b></a> &nbsp; ";
			 ...
			 echo "<a  class='btn btn-xs btn-success' style='padding:1px 12px' href='".base_url()."produk/keranjang'> Keranjang <span class='badge'>".rupiah($isi_keranjang['jumlah'])."</span></a> ";
            echo "<a class='btn btn-xs btn-success' style='width:60px' href='".base_url()."auth/login'>Login</a> 
				  <a class='btn btn-xs btn-success' style='width:60px;' href='".base_url()."auth/register'>Daftar</a>
				  <a class='btn btn-xs btn-success' style='width:60px;' href='".base_url()."reseller'>Penjual</a>";
