...
insert  into `menu`(`id_menu`,`id_parent`,`nama_menu`,`link`,`aktif`,`position`,`urutan`) values (115,0,'Alamat Kami','halaman/detail/alamat-perusahaan','Ya','Top',3),(113,0,'Tentang Kami','halaman/detail/tentang-kami-tunggul-news','Ya','Top',2),(112,22,'Dalam Negeri','#','Ya','Bottom',20),(161,0,'Order Report','members/orders_report','Ya','Bottom',26),(116,0,'Hubungi Kami','hubungi','Ya','Top',4),(119,0,'Index Berita','berita/indeks_berita','Ya','Top',1),(126,22,'Luar Negeri','#','Ya','Bottom',21),(160,0,'Konfirmasi Pembayaran','konfirmasi','Ya','Bottom',25),(158,0,'Semua Penjual','produk/reseller','Ya','Bottom',23),(157,0,'Semua Produk','produk','Ya','Bottom',22);
...
insert  into `rb_penjualan_detail`(`id_penjualan_detail`,`id_penjualan`,`id_produk`,`jumlah`,`diskon`,`harga_jual`,`satuan`) values (184,117,38,1,0,0,'unit'),(183,116,37,1,0,0,'unit'),(182,115,36,1,0,0,'unit'),(181,114,35,1,0,0,'unit'),(180,113,34,1,0,0,'unit'),(179,112,33,1,0,0,'unit'),(178,111,32,1,0,0,'unit'),(177,110,31,1,0,0,'unit'),(176,109,30,1,0,0,'unit'),(174,107,28,1,0,0,'unit'),(175,108,29,1,0,0,'unit'),(173,106,27,1,0,5000000,'unit'),(172,105,27,1,0,5000000,'unit');
