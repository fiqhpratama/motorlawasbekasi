...
insert  into `rb_konsumen`(`id_konsumen`,`username`,`password`,`nama_lengkap`,`email`,`jenis_kelamin`,`tanggal_lahir`,`tempat_lahir`,`alamat_lengkap`,`kecamatan`,`kota_id`,`no_hp`,`foto`,`tanggal_daftar`) values (30,'saitama','9970f16668b0ce09b694293b5164ae2b211fb9a23e9026bb4d0d1aef370f192120dd5f5a8e78c06d57fa036de0975c09b528ea7dc49262aee10c3247e62964fa','Botak Saitama','saitamabotak@gmail.com','Laki-laki','0000-00-00','','Jln.Mawar 5','Poncol',440,'087445565','','2019-07-13');
...
insert  into `rb_penjualan`(`id_penjualan`,`kode_transaksi`,`id_pembeli`,`id_penjual`,`status_pembeli`,`status_penjual`,`kurir`,`service`,`ongkir`,`waktu_transaksi`,`proses`) values (138,'TRX-20190714215730',12,1,'reseller','admin','','Stok Otomatis (Pribadi)',0,'2019-07-14 21:57:30','1'),(139,'TRX-20190714215749',30,12,'konsumen','reseller','jne','OKE',13000,'2019-07-14 21:57:49','3'),(140,'TRX-20190714223302',30,12,'konsumen','reseller','pos','Express Next Day Barang',22000,'2019-07-14 22:33:02','3'),(141,'TRX-20190714225101',30,12,'konsumen','reseller','jne','OKE',13000,'2019-07-14 23:08:30','3'),(142,'TRX-20190714231249',30,12,'konsumen','reseller','jne','OKE',13000,'2019-07-14 23:12:49','3');
...
insert  into `rb_penjualan_detail`(`id_penjualan_detail`,`id_penjualan`,`id_produk`,`jumlah`,`diskon`,`harga_jual`,`satuan`) values (205,138,47,22,0,500000,'unit'),(206,139,47,1,0,500000,'unit'),(207,140,47,1,0,500000,'unit'),(208,141,47,2,0,500000,'unit'),(209,142,47,1,0,500000,'unit');
...
CREATE TABLE `rb_produk` (
  ...
  `satuan` varchar(50) NOT NULL,
  `jenis_barang` enum('kendaraan','sparepart') DEFAULT NULL,
...
insert  into `rb_produk`(`id_produk`,`id_produk_perusahaan`,`id_kategori_produk`,`id_kategori_produk_sub`,`id_reseller`,`nama_produk`,`produk_seo`,`satuan`,`jenis_barang`,`harga_beli`,`harga_reseller`,`harga_konsumen`,`berat`,`gambar`,`keterangan`,`username`,`waktu_input`) values (38,0,13,9,1,'Vespa Super','vespa-super','unit','kendaraan',8500000,0,9900000,'9000','Super.png','<p>Mesin 2 Tak</p><p>Pengapian Platina</p><p>Bore x Stroke 57 x 57 mm</p><p>Kapasitas 150 CC</p><p>Kelistrikan 6/12 volt</p><p><br></p><p>Khusus COD</p>','reseller','2019-07-07 22:25:09'),(33,0,13,8,1,'Yamaha AS 3 Twin','yamaha-as-3-twin','unit','kendaraan',6500000,0,8000000,'5600','YamahaAs3.png','<p>Mesin : 2 Tak 2 Silinder</p><p>Kapasitas Mesin : 125 CC</p><p>Bore x Stroke : 43 x 43 mm</p><p>Max Power : 11,7 kw 9800 Rpm</p><p>Top Speed : 127 Kpj</p><p>Transmisi : 4 percepatan</p><p><br></p><p>Khusus COD</p>','reseller','2019-07-07 22:05:15'),(34,0,13,8,1,'Yamaha RS-100','yamaha-rs100','unit','kendaraan',6600000,0,8500000,'6700','Untitled1.png','<p>Mesin : 2 Tak 2 Silinder</p><p>Kapasitas : 97 CC</p><p>Bore x Stroke : 52 x 45,6 mm</p><p>Max Power : 10.5 hp 7500 Rpm</p><p>Transmisi : 5 Percepatan</p><p><br></p><p>Khusus COD</p>','reseller','2019-07-07 22:11:22'),(35,0,13,7,1,'Suzuki RC-80','suzuki-rc80','unit','kendaraan',450000,0,5500000,'6500','SuzukiRC80.png','<p>Mesin : 2 Tak Reed Valve JetCooled</p><p>Bore x Stroke : 47 x 46 mm</p><p>Transmisi 4 Percepatan</p><p>Starter Electric &amp; Kick</p><p><br></p><p>Khusus COD</p>','reseller','2019-07-07 22:15:24'),(36,0,13,7,1,'Suzuki GT-185','suzuki-gt185','unit','kendaraan',7000000,0,9500000,'6700','GT185.png','<p>Mesin : 2 Tak 2 Silinder</p><p>Kapasitas : 184 CC</p><p>Transmisi : 5 Percepatan</p><p>Pengapian : CDI</p><p>Wheelbase : 1290 mm</p><p><br></p><p>Khusus COD</p>','reseller','2019-07-07 22:19:06'),(37,0,13,9,1,'Vespa Sprinter','vespa-sprinter','unit','kendaraan',7000000,0,10000000,'9000','Sprint.png','<p>Mesin : 2 Tak 1 Silinder</p><p>Bore x Stroke : 57 x 57 mm</p><p>Kapasitas : 145 CC</p><p>Max Power : 7.1 hp @5000 Rpm</p><p>Transmisi 4 Percepatan</p><p><br></p><p>Khusus COD</p>','reseller','2019-07-07 22:22:24'),(27,0,13,6,0,'Honda C-50 ','honda-c50-','unit','kendaraan',5000000,5000000,5000000,'500','C50.png','<p>Mesin 4 Tak OHC 1 Silinder</p>\r\n\r\n<p>Kapasitas Mesin 49.5 CC</p>\r\n\r\n<p>Rasio Kompresi 8.8 : 1</p>\r\n\r\n<p>Max Power 4.8 BHP @10000RPM</p>\r\n\r\n<p>Transmisi 3 Speed (N-1-2-3)</p>\r\n\r\n<p>Karburator : Keihin</p>\r\n\r\n<p>Pengapian : Platina</p>\r\n\r\n<p>Battery : ACCU 6V</p>\r\n\r\n<p>Starter : Kick</p>\r\n','admin','2019-07-07 21:11:49'),(28,0,13,6,1,'Honda C-50 ','honda-c50-','unit','kendaraan',5000000,0,6000000,'500','C501.png','<p>\r\n\r\n</p><p>Mesin 4 Tak OHC 1 Silinder</p><p>Kapasitas Mesin 49.5 CC</p><p>Rasio Kompresi 8.8 : 1</p><p>Max Power 4.8 BHP @10000RPM</p><p>Transmisi 3 Speed (N-1-2-3)</p><p>Karburator : Keihin</p><p>Pengapian : Platina</p><p>Battery : ACCU 6V</p><p>Starter : Kick</p><p><br></p><p>Khusus COD</p><p></p>','reseller','2019-07-07 21:18:19'),(32,0,13,6,1,'Honda XL 125','honda-xl-125','unit','kendaraan',6500000,0,8000000,'6000','Untitled.png','<p>Mesin : 4 Tak OHC 1 Silinder</p><p>Kapasitas : 124 CC</p><p>Bore X Stroke : 56x49 mm</p><p>Pengapian : Platina</p><p>Starter Kick</p><p>Max Power : 12.5 @10000 Rpm</p><p>Trasmisi : 4 Percepatan</p><p><br></p><p>Khusus COD</p>','reseller','2019-07-07 22:01:02'),(29,0,13,6,1,'Honda C-70','honda-c70','unit','kendaraan',5000000,0,7000000,'4500','C70.png','<p>Mesin : OHC, 4 Tak</p><p>Kapasitas : 71,8 CC</p><p>Bore x Stroke : 47 x 41,4 mm</p><p>Rasio Kompresi : 8,8 : 1</p><p>Sistem Pendingin : Udara</p><p>Max Power : 4,5 kW (6 bhp) @9000 Rpm</p><p>Max Torque : 0.53 kg.m @7000 Rpm</p><p>Sistem pengapian : Platina</p><p><br></p><p>Khusus COD</p>','reseller','2019-07-07 21:42:34'),(30,0,13,6,1,'Honda CB-100','honda-cb100','unit','kendaraan',6000000,0,7500000,'5000','HondaCB100.png','<p>Kapasitas Mesin : 99 CC, OHC</p><p>Mesin : 4 Tak 1 Silinder</p><p>Power : 11,5 HP @10.500 Rpm</p><p>Top Speed : 110 km/h</p><p>Bore x Stroke : 50.5 x 49,5 mm</p><p>Pengapian : Platina</p><p>Transmisi : 5 Speed</p><p><br></p><p>Khusus COD</p>','reseller','2019-07-07 21:48:21'),(31,0,13,6,1,'Honda S-90','honda-s90','unit','kendaraan',400000,0,5500000,'4500','S90.png','<p>Mesin : 4 Tak OHC 1 Silinder</p><p>Kapasitas : 89 CC</p><p>Max Power : 8,02 HP @9500 Rpm</p><p>Max Torsi : 6,37 HP @8000 Rpm</p><p>Transmisi : Manual&nbsp; 4 Percepatan</p><p><br></p><p>Khusus COD</p>','reseller','2019-07-07 21:48:51'),(39,0,12,10,12,'Sen Honda CB-100','sen-honda-cb100','unit','sparepart',250000,0,300000,'450','Sen1.jpg','<p>Second Mulus</p>','lapakretro','2019-07-12 20:55:39'),(40,0,12,10,12,'Spedo Honda C-70','spedo-honda-c70','unit','sparepart',450000,0,500000,'300','Spedo.jpg','<p>Second Mulus</p>','lapakretro','2019-07-12 20:57:25'),(41,0,12,10,12,'Tanki Honda S-90','tanki-honda-s90','unit','sparepart',440000,0,550000,'650','Tanki.jpg','<p>Second Mulus</p>','lapakretro','2019-07-12 20:58:32'),(42,0,12,11,12,'Lampu Belakang Yamaha RS-100','lampu-belakang-yamaha-rs100','unit','sparepart',340000,0,450000,'250','2503496_7aec2694-eca4-47de-a33e-b41540aa9eae_1500_1500.jpg','<p>Second Baru</p>','lapakretro','2019-07-12 21:01:09'),(43,0,12,11,12,'Spedo Yamaha AS Twin','spedo-yamaha-as-twin','unit','sparepart',600000,0,650000,'450','speedometer_dan_tachometer_yamaha_RX125_Twin_original_yamaha.jpg','<p>Second Mulus</p>','lapakretro','2019-07-12 21:10:41'),(44,0,12,12,12,'Knalpot Suzuki GT-185','knalpot-suzuki-gt185','unit','sparepart',800000,0,1000000,'750','Knalpot_Suzuki_GT185_-_kiri,_Original.jpg','<p>\r\n\r\nSecond Mulus\r\n\r\n<br></p>','lapakretro','2019-07-12 21:12:20'),(45,0,12,12,12,'Sayap Suzuki RC','sayap-suzuki-rc','unit','sparepart',450000,0,500000,'350','Sayap_Suzuki_RC_Bravo.jpg','<p>\r\n\r\nSecond Mulus\r\n\r\n<br></p>','lapakretro','2019-07-12 21:12:55'),(46,0,12,13,12,'Tali Kopling','tali-kopling','unit','sparepart',250000,0,300000,'250','inilah-harga-kabel-kopling-vespa-terbaru.jpg','<p>\r\n\r\nSecond Mulus\r\n\r\n<br></p>','lapakretro','2019-07-12 21:14:17'),(47,0,12,13,12,'Lampu Depan Excel','lampu-depan-excel','unit','sparepart',450000,0,500000,'650','Lapu_depan_excel.jpg','<p>\r\n\r\nSecond Mulus\r\n\r\n<br></p>','lapakretro','2019-07-12 21:14:56');
...
insert  into `rb_produk_diskon`(`id_produk_diskon`,`id_produk`,`id_reseller`,`diskon`) values (24,34,1,0),(23,32,1,0),(22,29,1,0),(21,30,1,0),(20,31,1,0),(19,28,1,0),(25,38,1,0),(26,47,12,0);
...
insert  into `rb_rekening`(`id_rekening`,`nama_bank`,`no_rekening`,`pemilik_rekening`) values (1,'MANDIRI','15512677235','Motor Lawas Bekasi'),(2,'BCA','1122554216','Motor Lawas Bekasi');
...
insert  into `rb_rekening_reseller`(`id_rekening_reseller`,`id_reseller`,`nama_bank`,`no_rekening`,`pemilik_rekening`) values (1,2,'Bank Danamon','56234234000','Syarii Sentral'),(2,2,'Bank BCA','10823422','Syarii Sentral'),(3,3,'Bank Mandiri','234123123332','Kalifah Umayyah'),(6,1,'BCA','0123456789','Tukang Rongsok'),(7,12,'Mandiri','4534542356546','Lapak Retro'),(8,12,'BCA','87967856756','Lapak Retro');
...
insert  into `users`(`username`,`password`,`nama_lengkap`,`email`,`no_telp`,`foto`,`level`,`blokir`,`id_session`) values ('admin','edbd881f1ee2f76ba0bd70fd184f87711be991a0401fd07ccd4b199665f00761afc91731d8d8ba6cbb188b2ed5bfb465b9f3d30231eb0430b9f90fe91d136648','Galih ','admin@admin.com','081267771344','download.png','admin','N','q173s8hs1jl04st35169ccl8o7'),('bewok','7d0b6095ec1ee6163eb1754de765184b2f9043bf7b5ce8a2b365b634bb8f56b565cd8f8baa8c62683a26d028aa54a60909ad413d2f0dad98e02c77bc5556a1bb','Bewok Bucindteross','bewokbucin@gmail.com','08777254156562','Capture.JPG','admin','N','7352bbb5eb4ba56e8334acb91ac5add1-20190712195534');
